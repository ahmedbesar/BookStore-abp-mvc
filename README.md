...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 62f8accc-546c-43d3-9aab-c004e44ba94c
```

> `62f8accc-546c-43d3-9aab-c004e44ba94c` is the password of the certificate, you can change it to any password you want.
