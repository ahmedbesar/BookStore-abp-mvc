$(function () {
    let l = abp.localization.getResource('BookStore');
    let createModal = new abp.ModalManager(abp.appPath + 'Authors/CreateModal');
    let editModal = new abp.ModalManager(abp.appPath + 'Authors/EditModal');

    let dataTable = $('#AuthorsTable').DataTable(
